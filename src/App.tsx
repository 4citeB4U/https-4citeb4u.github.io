...
const BookCard = ({ book, onOpenBook }) => {
  ...
  return (
    <div
      className="relative rounded-lg overflow-hidden bg-gray-900 bg-opacity-60 backdrop-blur-sm border border-gray-700 transition-all duration-500 h-full flex flex-col"
      style={{
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <button 
            ...
            className={`px-8 py-4 text-white rounded-lg transform transition text-xl font-bold ${isHovered ? 'scale-110' : ''}`}
            style={{ 
              backgroundColor: book.bubbleColor,
      ...
      <div className="p-4 pt-0 flex justify-center">
        <button
          ...
          className="w-full py-4 text-white rounded-lg font-bold text-xl shadow-lg hover:shadow-xl transition-all"
