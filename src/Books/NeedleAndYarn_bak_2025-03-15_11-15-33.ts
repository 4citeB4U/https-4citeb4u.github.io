...
Leola Lee`
    ...
    {
      title: "Index",
      content: `🌟 Prologue: A Stitch in Time
...
🧶 Appendix: The Crocheter's Companion`
    },
    {
      ...
      content: `“Gather 'round, my dears, and let Sista Lee spin you a tale. Not just any tale, mind you, but a love story woven with the very threads of creation. Imagine a world where the tools of our craft aren't just inanimate objects, but living, breathing beings with hearts that yearn, dreams that soar, and stories that whisper of connection and belonging.
...
"Oh, my stars! I seem to have gotten myself into a bit of a… well, a right proper mess!" The voice was bright, a splash of sunshine. Needle, startled from his musings, looked up. It was Yarn, a glorious, tangled explosion of sunset orange cotton.
...
Maintaining Tension:
"Imagine the perfect balance in a dance— not too rigid, not too loose."
...
"Block your squares to flatten them before joining. Keep corners neat, count your stitches!"`
    },
    {
      ...
      content: `Despite progress, Yarn felt dull— her vibrant color had faded from handling and tangles. In strolled Color Dye, the traveling dye salesman, brimming with flair. "You're in need of a color revival, my dear!" With Leola's help, Yarn soaked in carefully mixed dyes, reemerging with renewed brilliance. It wasn't just about color; it was her soul reawakened.`
    },
    {
